...
// Helper: combina fecha_creacion (DATE) + hora_creacion (STRING HH:MM:SS)
...
// Helper: genera el WHERE de fechas
...
// Helper: normaliza campo que puede ser DATETIME nativo o STRING DD/MM/YYYY
const toTS = (field) =>
  `COALESCE(
...
// --- Volumen y cumplimiento por hora -----------------------------------------
